...
sudo qemu-system-aarch64 -M virt -cpu cortex-a57 \
-m 2048 -nographic -smp 4 -kernel  /local/repository/qemu-images/Image \
-append "root=/dev/vda console=ttyAMA0" \
-drive file= /local/repository/qemu-images/rootfs.ext4,format=raw,id=hd0
